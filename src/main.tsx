  ...
  <StrictMode>
    <ErrorBoundary
      fallback={() => (
        <div
          role="alert"
          className="fixed inset-0 flex flex-col items-center justify-center bg-stone-100 text-stone-900 dark:bg-stone-900 dark:text-stone-100 p-6 text-center z-50"
        >
