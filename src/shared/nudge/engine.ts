 ...
 *
 * This is the integration point called by UI components (NutritionalTrafficLightContainer, MetabolicTrackerContainer,
 * ActivityTrackerContainer) whenever a user action might trigger nudges.
 *
